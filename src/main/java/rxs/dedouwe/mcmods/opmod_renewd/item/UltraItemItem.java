...
public class UltraItemItem extends OpmodModElements.ModElement {
	@ObjectHolder("opmod:ultra_item")
	public static final Item block = null;
	public UltraItemItem(OpmodModElements instance) {
		super(instance, 30);
	}
