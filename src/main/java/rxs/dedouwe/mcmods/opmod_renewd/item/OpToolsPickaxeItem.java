...
public class OpToolsPickaxeItem extends OpmodModElements.ModElement {
	@ObjectHolder("opmod:op_tools_pickaxe")
	public static final Item block = null;
	public OpToolsPickaxeItem(OpmodModElements instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("op_tools_pickaxe"));
	}
}
