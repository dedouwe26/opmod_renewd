...
public class UltraMagicCoreItem extends OpmodModElements.ModElement {
	@ObjectHolder("opmod:ultra_magic_core")
	public static final Item block = null;
	public UltraMagicCoreItem(OpmodModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ultra_magic_core");
		}
